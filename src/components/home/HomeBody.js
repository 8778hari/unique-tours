            ...
            <div className='home_discover'>
                ...
                <div className='home_discover_container'>
                    <div className='discover_item'>
                        <img className="discover_item_img" src='/images/vision.jpg'></img>
                    ...
                    <div className='discover_item'>
                        <img className="discover_item_img" src='/images/expertise.jpg'></img>
                        <div className='discover_details'>
                            <h1>Our Expertise</h1>
                    ...
                    <div className='discover_item'>
                        <img className="discover_item_img" src='/images/services.jpg'></img>
                        <div className='discover_details'>
                            <h1>Our Services</h1>
            ...
            <div className='home_gallery_container'>
                ...
                <div className='home_gallery'>
                    <div className='gallery_item'>
                        <img className='gallery_image' src='images/img1.jpg'></img>
                    </div>
                    <div className='gallery_item'>
                        <img className='gallery_image' src='images/img2.jpg'></img>
                    </div>
                    <div className='gallery_item'>
                        <img className='gallery_image' src='images/img3.jpg'></img>
                    </div>
                    <div className='gallery_item'>
                        <img className='gallery_image' src='images/img4.jpg'></img>
                    </div>
                    <div className='gallery_item'>
                        <img className='gallery_image' src='images/img5.jpg'></img>
                    </div>
                    <div className='gallery_item'>
                        <img className='gallery_image' src='images/img6.jpg'></img>
                    </div>
                    <div className='gallery_item'>
                        <img className='gallery_image' src='images/img7.jpg'></img>
                    </div>
                    <div className='gallery_item'>
                        <img className='gallery_image' src='images/img8.jpg'></img>
                    </div>
                </div>
            </div>
        </div>
